...
/****** Get a list of messages between two users ******/
	...
	(
		$uniID1				// <int> The first UniID involved in the exchange.
	,	$uniID2				// <int> The second UniID involved in the exchange.
	,	$messageCount = 15	// <int> The number of messages to return.
	)						// RETURNS <int:[str:mixed]> a list of messages to return.
...
/****** Get a list of messages between two users ******/
	...
	(
		$uniID1			// <int> The first UniID involved in the exchange.
	,	$uniID2			// <int> The second UniID involved in the exchange.
	,	$microtime		// <float> The timestamp to return messages after.
	)					// RETURNS <int:[str:mixed]> A list of messages to return.
...
/****** Create a message between two users ******/
	...
	(
		$senderID		// <int> The UniID that is sending the message.
	,	$recipientID	// <int> The UniID that is receiving the message.
...
/****** Create a message between two users ******/
	...
	(
		$uniID1		// <int> The UniID that is sending the message.
	,	$uniID2		// <int> The UniID that is receiving the message.
	)				// RETURNS <bool> TRUE on success, FALSE on failure.
