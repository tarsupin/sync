...
/****** Plugin Variables ******/
	public static int $pruneDuration = 2592000;		// <int> Duration of time before pruning; default is one month.
	public static int $feedID = 0;					// <int> The Feed ID of a newly created entry.
	
	
/****** Get a Feed Entry ******/
	public static function get
	(
		int $feedID		// <int> The ID of the feed entry to retrieve.
	): array <str, mixed>				// RETURNS <str:mixed> the data of the feed entry.
...
/****** Create or update a Feed Entry ******/
	...
	(
		string $siteHandle		// <str> The site handle that submitted the entry.
	,	int $authorID		// <int> The UniID that authored the original content.
	,	string $url			// <str> The URL that the entry will be sourced from.
	,	string $title			// <str> The title of the entry.
	,	string $description	// <str> The description for the entry.
	,	string $thumbnail		// <str> The URL of the image to associate with the entry, if applicable.
	,	string $primeHashtag	// <str> The primary hashtag associated with the feed.
	,	array <int, str> $hashtagList	// <int:str> The list of hashtags associated with the feed.
	): bool					// RETURNS <bool> TRUE if the entry is created, FALSE if not.
