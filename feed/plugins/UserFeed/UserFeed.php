...
/****** Plugin Variables ******/
	public static $updateDuration = 180;		// <int> Duration between feed updates. Base 3 minutes.
	public static $maxUpdateMicroSeconds = 700;	// <int> Number of microseconds to allow for an update; 0.7 seconds.
	public static $loopCount = 1000;			// <int> The number of rows to search during an update loop.
	
	
/****** Follow a hashtag ******/
	public static function follow
	(
		$uniID		// <int> The UniID to have follow a hashtag.
	,	$hashtag	// <str> The hashtag that the user is being assigned to follow.
	)				// RETURNS <bool> TRUE if the hashtag was followed, FALSE if an error occurred.
...
/****** Unfollow a hashtag ******/
	...
	(
		$uniID		// <int> The UniID to have unfollow a hashtag.
	,	$hashtag	// <str> The hashtag that the user is unfollowing.
	)				// RETURNS <bool> TRUE if the feed was followed, FALSE if an error occurred.
...
/****** Get a list of hashtags that a user follows for a user ******/
	...
	(
		$uniID			// <int> The UniID to retrieve the list of hashtags from.
	)					// RETURNS <int:str> The hashtags the user is following.
...
/****** Get a list of hashtags in a STR:BOOL format ******/
	...
	(
		$uniID			// <int> The UniID to retrieve the list of hashtags from.
	)					// RETURNS <str:bool> The hashtags the user is following.
...
/****** Update a user's feed ******/
	...
	(
		$uniID		// <int> The UniID of the feed to update.
	)				// RETURNS <bool> TRUE if you've updated the feed, FALSE if not.
...
/****** Retrieve a User's Feed Posts ******/
	...
	(
		$uniID			// <int> The UniID of whose feed to retrieve.
	,	$page = 1		// <int> The page to retrieve from the feed.
	,	$showNum = 15	// <int> The number of rows to retrieve.
	)					// RETURNS <void> OUTPUTS the feed.
